(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (T. Rowe Price Group, Inc.,
  LEI 549300SIV6FPS9Y7IH33) -- unlike `commitledger.store`'s multi-application
...
(def ^:private demo-full-text
  "Terms of Use\nBy accessing this website you agree to these Terms of Use. The content of this site is provided by T. Rowe Price Group, Inc. and its affiliates for informational purposes only and does not constitute investment advice or an offer to sell any security. These Terms are governed by the laws of the State of Maryland.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.troweprice.com/en/jp/terms-of-use"
